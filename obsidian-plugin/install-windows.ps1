...
#
# ENCODING NOTE: this file is saved as UTF-8 with BOM. PowerShell 5.1 (the
# default on Windows 10/11) reads BOM-less files as CP1252, which corrupts
# any non-ASCII byte and causes parser errors mid-string. The BOM forces
# PS 5.1 to decode as UTF-8. The file body is also kept pure ASCII as a
# belt-and-suspenders second line of defense.

#Requires -Version 5.1
$ErrorActionPreference = 'Stop'

# Force UTF-8 for our own Write-Host output so banner art renders the same
# in conhost (cmd.exe) and Windows Terminal.
